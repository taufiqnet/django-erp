...
class Category(models.Model):
    business = models.ForeignKey(Business, on_delete=models.CASCADE, related_name='ecom_cat')
...
class Unit(models.Model):
    business = models.ForeignKey(Business, on_delete=models.CASCADE, related_name='ecom_unit')
...
class Product(models.Model):
    ...
    business = models.ForeignKey(Business, on_delete=models.CASCADE, related_name='ecom_product')
    ...
    # Media
    image = models.ImageField(upload_to='ecomproducts/', blank=True, null=True)
    ...
    # Relations
    supplier = models.ForeignKey(Contact, on_delete=models.SET_NULL, null=True, blank=True, limit_choices_to={'type': 'supplier'}, related_name='ecom_product_supplier')
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True, blank=True, null=True)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='created_products_ecom')
    updated_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='updated_products_ecom')
...
class Sale(models.Model):
    ...
    # Relationships
    business = models.ForeignKey(Business, on_delete=models.PROTECT, related_name='ecom_business_sales')
    customer = models.ForeignKey(
        Contact,
        on_delete=models.PROTECT,
        related_name='ecom_sales',
        null=True,
        blank=True,
    ...
    created_by = models.ForeignKey(
        ...
        on_delete=models.PROTECT,
        related_name='ecom_created_sales'
    )
    updated_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='ecom_updated_sales'
    )
...
class SaleItem(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.PROTECT, related_name='ecom_sale_items')
...
class Payment(models.Model):
    ...
    sale = models.ForeignKey(Sale, on_delete=models.CASCADE, related_name='ecom_payments')
    ...
    notes = models.TextField(blank=True, null=True)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='ecom_created_payments')
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True, blank=True, null=True)
